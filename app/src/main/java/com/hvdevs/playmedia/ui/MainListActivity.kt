...
//        Toast.makeText(this, date.toString(), Toast.LENGTH_SHORT).show()
        ...
        helperAdapter = HelperAdapter(this, itemList)
    ...
    private fun getParentData() {
        var j = 0
        dbParent = FirebaseDatabase.getInstance().getReference("name")
    ...
    private fun getChildData(parent: String, j: Int) {
        dbChild = FirebaseDatabase.getInstance().getReference("name/$j/samples")
